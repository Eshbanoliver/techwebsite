...
import TechStackSkeleton from '@/components/TechStackSkeleton';
import FAQSkeleton from '@/components/FAQSkeleton';

import IndustriesSkeleton from '@/components/IndustriesSkeleton';
...
const CategorizedFAQ = dynamic(() => import('@/components/CategorizedFAQ'), { 
  ssr: false,
  loading: () => <FAQSkeleton />
});
import SectionReveal from '@/components/SectionReveal';
const IndustriesMatrix = dynamic(() => import('@/components/IndustriesMatrix'), { 
  ssr: false,
